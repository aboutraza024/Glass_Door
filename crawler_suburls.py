...
# print(urls)
# crawl_suburls(["https://www.glassdoor.co.uk/Salary/Bon-Soiree-Salaries-E10196089.htm",
#                "https://www.glassdoor.co.uk/Salary/TravelConnect-Salaries-E1189862.htm"])
...
@browser(parallel=concurrency,max_retry=20,output=None,close_on_crash=True,raise_exception=True,create_error_logs=True)
def scrape_heading_task(driver: Driver, link):
    ...
    try:
        ...
        while True:
            ...
            logger.info(f"Page {page_number} error: Found {len(companies_jobs_suburls)} ")
    except Exception as e:
...
if __name__ == "__main__":
    ...
    result=scrape_heading_task(["https://www.glassdoor.co.uk/Salary/CMG-France-Salaries-E2968945.htm","https://www.glassdoor.co.uk/Salary/TravelConnect-Salaries-E1189862.htm"])
